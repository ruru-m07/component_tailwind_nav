          ...
          <div className=" h-14 bg-gray-950 flex items-center justify-between border-b-red-600">
            ...
            <label className="md:hidden">
              <button
                ...
                class="bi bi-x-lg text-lg w-16 text-white ml-4 "
              ></button>
            </label>
          </div>
            ...
            <div className=" grid  h-[99%] content-between">
              <div>
                <div>
                  <div className=" m-3">
                    <div className="rounded-lg text-zinc-400 hover:text-white bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-columns-gap text-xl  ml-4 mr-2 "></i>
                      <div className=" ">Dashbord</div>
                    </div>
                  </div>
                  <div className=" m-3">
                    <div className="rounded-lg text-zinc-400 hover:text-white bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-folder text-xl  ml-4 mr-2 "></i>
                      <div className=" ">Projects</div>
                    </div>
                  </div>
                  <div className=" m-3">
                    <div className=" text-zinc-400 hover:text-white  rounded-lg bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-people text-xl  ml-4 mr-2 "></i>
                      <div className=" ">Team</div>
                    </div>
                  </div>
                  <div className=" m-3">
                    <div className=" text-zinc-400 hover:text-white rounded-lg bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-chat-left-text text-xl ml-4 mr-2 "></i>
                      <div className="">message</div>
                    </div>
                  </div>
                  <div className=" m-3">
                    <div className=" text-zinc-400 hover:text-white rounded-lg bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-puzzle text-xl ml-4 mr-2 "></i>
                ...
                <div>
                  ...
                  <div className=" m-3">
                    <div className=" text-zinc-400 hover:text-white rounded-lg bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <div class="border rounded border-gray-500 bg-gray-700 h-[25px] w-[25px] text-xl ml-4 mr-2 flex justify-center items-center">
              ...
              <div>
                ...
                <div>
                  <div className=" m-3">
                    <div className="rounded-lg text-zinc-400 hover:text-white    bg-gray-950 hover:bg-zinc-800 h-10 flex  items-center">
                      <i class="bi bi-gear text-xl  ml-4 mr-2 "></i>
              ...
              <div className="h-full w-full flex items-center">
                <div className=" flex">
                  <label className="md:hidden">
                    <button
                      onClick={sidebar}
                      class="bi bi-three-dots-vertical text-lg text-white ml-4 mr-2 "
                    ></button>
                  </label>
                  <label>
                    <i class="bi bi-search text-lg text-white ml-4 mr-2 "></i>
                  </label>
                </div>
                <div>
                  <input
                    type="text"
                    class="bg-transparent border-transparent focus:border-current focus:ring-0  ml-2 text-white focus:ring-inherit w-[10rem] p-2.5"
                    placeholder="Search..."
                  />
                </div>
              </div>
